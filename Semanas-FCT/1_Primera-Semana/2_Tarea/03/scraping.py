...
petition = requests.get(countries["Greece"])
...
petition = requests.get(countries["Italy"])
...
#POBLACIÓN
#tomo un punto de referencia, en este caso un enlace, para encontrar el título de Población (que sería el padre del a)
